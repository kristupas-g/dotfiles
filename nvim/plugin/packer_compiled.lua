...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/kristupasgaidys/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig",
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file LspInstall lua require("packer.load")({'nvim-lspconfig'}, { cmd = "LspInstall", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
