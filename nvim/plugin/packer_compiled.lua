...
_G.packer_plugins = {
  ...
  ["null-ls.nvim"] = {
    ...
    loaded = true,
    path = "/Users/kristupasgaidys/.local/share/nvim/site/pack/packer/start/null-ls.nvim",
  ...
  orgmode = {
    config = { "\27LJ\2\n4\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\25krisstupasgaidys.org\frequire\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
